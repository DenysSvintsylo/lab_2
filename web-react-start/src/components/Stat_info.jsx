...
const Stat_info = () => {
  ...
  // Завантаження даних про торгові центри
  ...
  // Обчислення кількості користувачів, які додали кожен ТЦ до улюблених
  ...
  // Знаходимо найбільш та найменш улюблені ТЦ
  ...
  // Обчислення кількості ТЦ в кожному місті
  ...
  // Знаходимо міста з найбільшою і найменшою кількістю ТЦ
